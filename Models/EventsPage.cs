namespace PROG_POE.Models
{
    public class EventsPage
    {
        ...
        public EventsPage(HashSet<Annoncement> annoncements, Dictionary<string, MunicipalityEvent> municipalityEvents, Dictionary<string, MunicipalityEvent> categorySearchEvents, Dictionary<string, MunicipalityEvent> dateSearchEvents, HashSet<string> categories)
        {
            this.annoncements = annoncements;
            this.municipalityEvents = municipalityEvents;
            this.categories = categories;
